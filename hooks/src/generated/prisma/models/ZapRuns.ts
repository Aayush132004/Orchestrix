...
// @ts-nocheck 
/*
 * This file exports the `ZapRuns` model and its related types.
 *
...
export type GetZapRunsAggregateType<T extends ZapRunsAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateZapRuns[P]>
    : Prisma.GetScalarType<T[P], AggregateZapRuns[P]>
}
...
export type GetZapRunsGroupByPayload<T extends ZapRunsGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ZapRunsGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ZapRunsGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ZapRunsGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ZapRunsGroupByOutputType[P]>
      }
    >
  >
...
export type ZapRunsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface ZapRunsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends ZapRunsCountArgs>(
    args?: Prisma.Subset<T, ZapRunsCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ZapRunsCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, ZapRunsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetZapRunsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
